...
const getData=async()=>{
  ...
  const savemydailyshift=()=>{
    ...
    let empName= employeeDataBase[employeName]?employeeDataBase[employeName]:"";
    let empid= employeeIdDataBase[employeName]?employeeIdDataBase[employeName]:"";

    // console.log(empName, empid,startTime,endTime,shiftType,location, "data");
    
    

    if (empName == '' || empid =='' || startTime == '' || endTime == '' || shiftType == '' || location == '') {
  ...
  return (
    ...
    >
      ...
      <View style={styles.selectionView}>
        <View style={styles.empShiftsContainer}>
          ...
          <DailyShiftsComponents
            ...
            mapData={employeeDataBase?employeeDataBase:null}
      ...
      <TouchableOpacity style={styles.saveButtonStyle} onPress={
        ()=>{
          savemydailyshift()
      ...
      >
        {openCalender ? (
          ...
          <>
            ...
            >
              <Text style={styles.empText}>{employeeDataBase[employeName]}</Text>
              <Text style={styles.empText}>{employeeIdDataBase[employeName]}</Text>
